...
namespace {
  ...
  const ObjectHpCounterField object_hp_counter_fields[] = {
    ...
    {"hp_trace_enabled", ObjectHpAggregate::sum},
    {"hp_trace_queue_length", ObjectHpAggregate::sum},
    {"hp_trace_written_count", ObjectHpAggregate::sum},
    {"hp_trace_drop_count", ObjectHpAggregate::sum},
    {"hp_trace_write_error_count", ObjectHpAggregate::sum},
