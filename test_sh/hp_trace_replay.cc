...
void write_summary(
  ...
  std::cout << std::setprecision(17)
            ...
            << '\n'
            << "arf_fast_model_count=" << HP_ARF_FAST_MODEL_COUNT << '\n'
            ...
            << "arf_fast_model_resets="
            << result.adaptation_stats.fast_model_reset_count << '\n'
            << "arf_fast_model_background_discards="
            << result.adaptation_stats.fast_model_background_discard_count
            << '\n'
